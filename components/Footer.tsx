  ...
  return (
    <footer className="flexStart footer">
      ...
      <div className='flexBetween footer_copyright'>
        <p>@ 2023 <a href="https://jashwanthvk.vkjashwanth.repl.co" target='_blank' className='hover:underline hover:text-gray'>Jashwanth Viswanath Karanam.</a> All Rights Reserved</p>
